...
const fetchData = async () => {
   // const { data: dataPostRespone } = $fetch(`${baseApiUrl}api/posts/${id}`)
   const dataPostRespone  = await $fetch(`${baseApiUrl}api/posts/${id}`)
   dataPostDetial.value = dataPostRespone
   console.log('ca;;', dataPostDetial.value)
} 
